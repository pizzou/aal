...
import jakarta.validation.constraints.*; import java.math.BigDecimal; import java.time.*; import java.util.UUID;
public final class AirCargoDtos {
 ...
 public record BookRequest(@NotNull UUID shipmentId,@NotBlank String carrierCode,@NotBlank String carrierName,@NotBlank String flightNumber,@NotNull Instant departureTime,Instant arrivalTime,@NotBlank String originCode,@NotBlank String destinationCode,@NotNull @Positive BigDecimal weightKg,@NotBlank String idempotencyKey){}
